...
class Clientes extends Component
{
    ...
    {
        //obtiene registros de busqueda
        $searchByName = Http::get('http://127.0.0.1:8000/api/likeClientes/' . $this->nombreEmpresa);
        $clientsFound = $searchByName->json();
        ...
        return view('livewire.clientes', compact('clients', 'totalClients', 'currentpage', 'clientsFound'));
    }
